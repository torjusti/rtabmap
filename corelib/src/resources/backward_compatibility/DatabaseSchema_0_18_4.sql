...
CREATE TABLE Data (
	...
	depth BLOB,               -- compressed image (Depth or Right image) - High confidence depth map
	depth_medium BLOB,        -- compressed image (Medium confidence depth map)
	depth_low BLOB,          -- compressed image (Low confidence depth map)
	confidence_map BLOB,      -- compressed image (Confidence map)
...
-- VERSION
-- *******************************************************************
INSERT INTO Admin(version) VALUES('0.18.4');
